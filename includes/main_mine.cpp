...
int main()
{
...

	{
		...
		// std::cout << "::pair<int, std::string> pair_four = ft::make_pair(68, \"D\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_five = ft::make_pair(69, \"E\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_six = ft::make_pair(70, \"F\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_seven = ft::make_pair(71, \"G\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_eight = ft::make_pair(72, \"H\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_nine = ft::make_pair(73, \"I\");" << RESET << std::endl;
		// std::cout << "::pair<int, std::string> pair_ten = ft::make_pair(74, \"J\");" << RESET << std::endl;
