...
/*   Updated: 2022/09/12 15:37:03 by gmorange         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void print_stack_int_mine(NAMESPACE::stack<int> stack)
{
	if (stack.empty())
		return ;
...
void print_stack_list_mine(NAMESPACE::stack< int, std::list<int> > stack)
{	
	if (stack.empty())
		return ;
...
void	print_vector_int_mine(NAMESPACE::vector<int> vec)
{
    NAMESPACE::vector<int>::iterator begin;
    NAMESPACE::vector<int>::iterator end;
...
void	print_vector_str_mine(NAMESPACE::vector<std::string> vec)
{
    NAMESPACE::vector<std::string>::iterator begin;
    NAMESPACE::vector<std::string>::iterator end;
...
void	print_map_int_str_mine(NAMESPACE::map<int, std::string> & map)
{
    NAMESPACE::map<int, std::string>::iterator begin;
...
int main()
{
...

	{
		...
		std::cout << "NAMESPACE::vector<int> vec1;" << RESET << std::endl << std::endl;
		...
		std::cout << "NAMESPACE::vector<int> vec2(100, 42);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<int> vec2(100, 42);
		...
		std::cout << "NAMESPACE::vector<int> vec3(vec2.begin(), vec2.end() - 92);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<int> vec3(vec2.begin(), vec2.end() - 92);
		...
		std::cout << "NAMESPACE::vector<int> vec4(vec2);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<int> vec4(vec2);
		...
		std::cout << "NAMESPACE::vector<int> vec5 = vec3;" << RESET << std::endl << std::endl;
		NAMESPACE::vector<int> vec5 = vec3;
		...
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<int> vec6(1000000);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<int> vec6(1000000);
...

	{
    	...
    	std::cout << BOLDGREEN   << std::endl << "---------- vec1 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "default constructor - Vector.hpp - line 62" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec1;" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec1;
		std::cout << "capacity(): " << vec1.capacity() << std::endl;
		print_vector_str_mine(vec1);

		std::cout << BOLDGREEN   << std::endl << "---------- vec2 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec2(100, \"Forty-two!\");" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec2(100, "Forty-two!");
		std::cout << "capacity(): " << vec2.capacity() << std::endl;
		std::cout << "size(): " << vec2.size() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec3 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "range constructor - Vector.hpp - line 86" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec3(vec2.begin(), vec2.end() - 92);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec3(vec2.begin(), vec2.end() - 92);
		std::cout << "capacity(): " << vec3.capacity() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec4 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "copy constructor - Vector.hpp - line 114" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec4(vec2);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec4(vec2);
		std::cout << "vec2.capacity(): " << vec2.capacity() << std::endl;
		std::cout << "vec2.size(): " << vec2.size() << std::endl;
		std::cout << "vec4.capacity(): " << vec4.capacity() << std::endl;
		std::cout << "vec4.size(): " << vec4.size() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec5 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "operator= - Vector.hpp - line 138" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec5 = vec3;" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec5 = vec3;
		std::cout << "vec3.capacity(): " << vec3.capacity() << std::endl;
		std::cout << "vec3.size(): " << vec3.size() << std::endl;
		std::cout << "vec5.capacity(): " << vec5.capacity() << std::endl;
		std::cout << "vec5.size(): " << vec5.size() << std::endl;
		...
		std::cout << BOLDGREEN   << std::endl << "---------- vec6 ----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "fill constructor - Vector.hpp - line 69" << RESET << std::endl;
		std::cout << "NAMESPACE::vector<std::string> vec6(1000000);" << RESET << std::endl << std::endl;
		NAMESPACE::vector<std::string> vec6(1000000);
		std::cout << "capacity(): " << vec6.capacity() << std::endl;
		std::cout << "size(): " << vec6.size() << std::endl;
...

	{
		...
		std::cout << "NAMESPACE::stack<int> stk1;" << RESET << std::endl << std::endl;
		NAMESPACE::stack<int> stk1;
		...
		std::cout << "NAMESPACE::stack<int> stk2 = stk1;" << RESET << std::endl << std::endl;
		NAMESPACE::stack<int> stk2 = stk1;
		...
		std::cout << "NAMESPACE::stack<int> stk3(stk2);" << RESET << std::endl << std::endl;
		NAMESPACE::stack<int> stk3(stk2);
		std::cout << "stk2.size(): " << stk2.size() << std::endl;
		print_stack_int_mine(stk2);
		std::cout << std::endl;
...

	{
		...
		std::cout << YELLOW << "default constructor - Stack.hpp - line 42" << RESET << std::endl;
		std::cout << "NAMESPACE::stack< int, std::list<int> > stk_lst1;" << RESET << std::endl << std::endl;
		NAMESPACE::stack< int, std::list<int> > stk_lst1;
		...
		std::cout << YELLOW << "operator= - Stack.hpp - line 53" << RESET << std::endl;
		std::cout << "NAMESPACE::stack< int, std::list<int> > stk_lst2 = stk_lst1;" << RESET << std::endl << std::endl;
		NAMESPACE::stack< int, std::list<int> > stk_lst2 = stk_lst1;
		...
		std::cout << BOLDGREEN   << std::endl << "------ stk3 && stk2 ------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "copy constructor - Stack.hpp - line 48" << RESET << std::endl;
		std::cout << "NAMESPACE::stack< int, std::list<int> > stk_lst3(stk_lst2);" << RESET << std::endl << std::endl;
		NAMESPACE::stack< int, std::list<int> > stk_lst3(stk_lst2);
...

	{
		...
		std::cout << "NAMESPACE::pair<int, int> p1(42, 41);" << RESET << std::endl << std::endl;
		NAMESPACE::pair<int, int> p1(42, 41);
		...
		std::cout << "NAMESPACE::pair<int, int> p2(43, 40);" << RESET << std::endl << std::endl;
		std::cout << "(p1 > p2)" << RESET << std::endl << std::endl;
		NAMESPACE::pair<int, int> p2(43, 40);
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;
...

	{
		...
		std::cout << BOLDGREEN   << std::endl << "----------- p1 -----------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "initialization constructor - Pair.hpp - line 50" << RESET << std::endl;
		std::cout << "NAMESPACE::pair<int, std::string> p1(42, \"Quarante-deux!\");" << RESET << std::endl << std::endl;
		NAMESPACE::pair<int, std::string> p1(42, "Quarante-deux!");
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;

		std::cout << BOLDGREEN   << std::endl << "-------- p2 && p1 --------" << RESET << std::endl << std::endl;
		std::cout << YELLOW << "operator> - Pair.hpp - line 97" << RESET << std::endl;
		std::cout << "NAMESPACE::pair<int, std::string> p2(43, \"Quarante!\");" << RESET << std::endl << std::endl;
		std::cout << "(p1 > p2)" << RESET << std::endl << std::endl;
		NAMESPACE::pair<int, std::string> p2(43, "Quarante!");
		std::cout << "p1.first: " << p1.first << " - p1.second: " << p1.second << std::endl;
		std::cout << "p2.first: " << p2.first << " - p2.second: " << p2.second << std::endl;
		std::cout << "(p1 > p2): " << (p1 > p2) << std::endl;
...

	{
		...
		std::cout << "NAMESPACE::map<int, std::string> map1;" << RESET << std::endl << std::endl;
		...
		std::cout << "NAMESPACE::pair<int, std::string> pair_one = NAMESPACE::make_pair(65, \"A\");" << RESET << std::endl;
		std::cout << "NAMESPACE::pair<int, std::string> pair_two = NAMESPACE::make_pair(66, \"B\");" << RESET << std::endl;
		std::cout << "NAMESPACE::pair<int, std::string> pair_three = NAMESPACE::make_pair(67, \"C\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_four = NAMESPACE::make_pair(68, \"D\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_five = NAMESPACE::make_pair(69, \"E\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_six = NAMESPACE::make_pair(70, \"F\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_seven = NAMESPACE::make_pair(71, \"G\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_eight = NAMESPACE::make_pair(72, \"H\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_nine = NAMESPACE::make_pair(73, \"I\");" << RESET << std::endl;
		// std::cout << "NAMESPACE::pair<int, std::string> pair_ten = NAMESPACE::make_pair(74, \"J\");" << RESET << std::endl;
		NAMESPACE::pair<int, std::string> pair_one = NAMESPACE::make_pair(65, "A");
		NAMESPACE::pair<int, std::string> pair_two = NAMESPACE::make_pair(66, "B");
		NAMESPACE::pair<int, std::string> pair_three = NAMESPACE::make_pair(67, "C");
		// NAMESPACE::pair<int, std::string> pair_four = NAMESPACE::make_pair(68, "D");
		// NAMESPACE::pair<int, std::string> pair_five = NAMESPACE::make_pair(69, "E");
		// NAMESPACE::pair<int, std::string> pair_six = NAMESPACE::make_pair(70, "F");
		// NAMESPACE::pair<int, std::string> pair_seven = NAMESPACE::make_pair(71, "G");
		// NAMESPACE::pair<int, std::string> pair_eight = NAMESPACE::make_pair(72, "H");
		// NAMESPACE::pair<int, std::string> pair_nine = NAMESPACE::make_pair(73, "I");
		// NAMESPACE::pair<int, std::string> pair_ten = NAMESPACE::make_pair(74, "J");
		...
		std::cout << "NAMESPACE::map<int, std::string> map2(map1.begin(), map1.end());" << RESET << std::endl << std::endl;
		NAMESPACE::map<int, std::string> map2(map1.begin(), map1.end());
		...
		std::cout << "NAMESPACE::map<int, std::string> map3;" << RESET << std::endl;
		...
		std::cout << "NAMESPACE::map<int, std::string> map4(map2);" << RESET << std::endl << std::endl;
		NAMESPACE::map<int, std::string> map4(map2);
		std::cout << std::endl << "map2: " << std::endl;
		print_map_int_str_mine(map2);
		...
		std::cout << "NAMESPACE::map<int, std::string> map5 = map4;" << RESET << std::endl << std::endl;
		NAMESPACE::map<int, std::string> map5 = map4;
		...
		NAMESPACE::map<int, std::string>::iterator it = map5.find(6600);
		if (it != map5.end())
...
void    print_vector_mine(NAMESPACE::random_access_iterator<int> begin, NAMESPACE::random_access_iterator<int> end)
{
    while (begin != end)
    {
        std::cout << *begin << std::endl;
...
int main()
{
...

	{
		...
		NAMESPACE::vector<int> vec3(3, 42);
		NAMESPACE::vector<int> vec4(3, 84);
	...
	{	
		...
		NAMESPACE::vector<int> vec2(1, 42);
...

	{
		...
		NAMESPACE::vector<int> vec2(6, 42);
...

	{
		...
		NAMESPACE::vector<int> vec2(2, 42);
		NAMESPACE::vector<int> vec2_to_add(3, 84);
		NAMESPACE::vector<int> vec2_to_add2(1, 8);
...

	{
		...
		NAMESPACE::vector<int> vec2(10, 33);
		NAMESPACE::vector<int> vec3(vec2);
		NAMESPACE::vector<int> vec4 = vec3;
...

	{
		...
		// NAMESPACE::vector<int> vec_vrai;
		// NAMESPACE::vector<int> vec_vrai(2);
		NAMESPACE::vector<int> vec_vrai(4, 46);

		NAMESPACE::vector<int> vec_to_add2(2, 78);
