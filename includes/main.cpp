...
//	}
	...
	for (int i = 0; i < COUNT; ++i)
	{
		std::cout << "--3-- : " << i << "/" << COUNT << std::endl;
		map_int.insert(NAMESPACE::make_pair(rand(), rand()));
		map_int.print_tree('i');
		std::cout << std::endl;
	}
//	std::cout << "---4---" << std::endl;
//
