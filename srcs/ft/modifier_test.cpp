...
void	modifier_test(void)
{
	...
	std::cout <<"-----5-----"<< std::endl;
	ft::vector<std::string>		fourth;
	ft::vector<std::string>		fifth;
	fourth.assign(3, "Hello !");
	print(fourth, "fourth");

	std::cout <<"-----6-----"<< std::endl;
	ft::vector<std::string>::const_iterator scit = fourth.begin();
	ft::vector<std::string>::const_iterator scite = fourth.end();
	ft::vector<std::string>::iterator sit = fourth.begin();
